...
try {
    ...
    Assert-True ($traceText.Contains("{com.monarchit.target.TargetApp.TargetApp} | INGRESS | ARGS")) "Missing constructor ARGS instrumentation marker"
    ...
    Assert-True ($traceText.Contains("{com.monarchit.target.TargetApp.filteredStackMethod} | INGRESS | STACK")) "Missing STACK filter instrumentation marker"
